  ...
  void _confirmDelete(BuildContext context) {
    showDialog(
      ...
      builder: (ctx) => AlertDialog(
        ...
        content: const Text(
            'Menghapus rekening akan menghapus semua transaksi terkait. Lanjutkan?'),
        actions: [
          TextButton(
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      listener: (context, state) {
        if (state is AccountLoaded && !_loaded) {
          // Pre-fill dari data yang sudah ada
